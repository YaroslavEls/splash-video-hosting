<div class="col-md-2" style="display:flex;flex-direction:column;align-items:center;margin-bottom:20px">
    ...
    <p style="font-weight:400;font-size:22px;margin-bottom:8px">Episode <?= $num+1 ?></p>
    <p><a class="btn btn-secondary" href="/watch/<?= $data->name ?>/episode/<?= $num+1 ?>">Watch &raquo;</a></p>
</div>