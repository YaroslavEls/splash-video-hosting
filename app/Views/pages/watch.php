...
<div class="album py-5 bg-light">
    <div class="container">
        <div class="row featurette justify-content-md-center align-items-center">
            ...
            <div class="col-md-6">
                <h2 class="featurette-heading fw-normal lh-1" style="letter-spacing: -.05rem;font-size: 50px;"><?= $data->name ?></h2>
                <p class="lead"><?= $data->desc ?></p>
                <p class="lead"><span style="font-weight:400">Genres: </span><?= implode(', ', $data->genres); ?></p>
                <p class="lead"><span style="font-weight:400">Rating: </span><?= $data->rating ?></p>
            </div>
        </div>
        ...
        <div class="row justify-content-md-center">
            <?php for($i = 0; $i < $data->episodes; $i++) : ?>
                <?= view('partials/seria', ['num' => $i]); ?>
            <?php endfor ?>
        </div>
    </div>
</div>
